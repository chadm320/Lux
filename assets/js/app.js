...
(0, _jquery2.default)("[data-menu-underline-from-center] a").addClass("underline-from-center");

(0, _jquery2.default)(document).ready(function () {

	(0, _jquery2.default)('#open-left-canvas').click(function () {
		(0, _jquery2.default)('.left-canvas').toggle();
	});

	(0, _jquery2.default)('#close-left-canvas').click(function () {
		(0, _jquery2.default)('.left-canvas').toggle();
	});
});
